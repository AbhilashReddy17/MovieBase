...
public class Movie implements Serializable,Parcelable {
    ...
    public final static Parcelable.Creator<ResponseMovies> CREATOR = new Creator<ResponseMovies>() {
        ...
        public ResponseMovies[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -3507849794191294226L;
